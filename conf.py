...
htmlhelp_basename = 'opedia_rtddoc'
...
latex_documents = [
    (master_doc, 'opedia_rtd.tex', 'opedia\\_rtd Documentation',
...
man_pages = [
    (master_doc, 'opedia_rtd', 'opedia_rtd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'opedia_rtd', 'opedia_rtd Documentation',
     author, 'opedia_rtd', 'One line description of project.',
     'Miscellaneous'),
]
